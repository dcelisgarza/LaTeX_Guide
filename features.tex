...
The following are common options of the \verb|\documentclass| command,
...
%
\verb|\input{}| and \verb|\include{}| are two \emph{very} special and
...
\verb|\input{filename}| is very low level, and it simply inserts
...
\verb|\include{filename}| is a bit more complicated and \emph{much}
